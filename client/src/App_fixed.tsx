              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                ...
                >
                  <div className="text-sm space-y-2">
                    ...
                    {!currentJob && (
                      <button
                        onClick={generateDemoClips}
                        className="mt-3 w-full flex items-center justify-center space-x-2 px-4 py-2 bg-gradient-to-r from-purple-500 to-indigo-600 text-white rounded-lg hover:from-purple-600 hover:to-indigo-700 transition-all duration-200"
                      >
