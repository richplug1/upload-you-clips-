...
import { Film, Scissors, HelpCircle, Settings, Coins, ArrowLeft, LogOut, User } from 'lucide-react';
              ...
              <div className="flex items-center space-x-3">
                {isAuthenticated ? (
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-xl hover:shadow-lg transition-all duration-300 hover:scale-105 flex items-center space-x-2"
                  >
